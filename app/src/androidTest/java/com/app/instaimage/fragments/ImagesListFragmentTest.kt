...
import com.app.instaimage.MainInstaImageActivity
...
class ImageListFragmentTest {
    ...
    @Rule
    @JvmField
    var activityScenarioRule = ActivityScenarioRule(MainInstaImageActivity::class.java)
    ...
    fun return_true_empty_section_is_showing() {
        runBlocking {
            onView(withId(R.id.searchView)).perform(replaceText("EmptyTExtSet"))
